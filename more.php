...
<body>
    ...
    <?php
    $jumbotron = mysqli_query($konek, "SELECT * FROM tb_jumbotron ");
    $d = mysqli_fetch_object($jumbotron);
    ?>
    <div class="container">
        <div class="card m-3">
            <div class="row g-0">
                <div class="col-md-6">
                    <img src="img/waerebo.jpg" class="img-fluid rounded-start img-thumbnail" alt="..." width="100%">
                    <img src="img/caci2.png" class="img-fluid rounded-start img-thumbnail" alt="..." width="100%">
                </div>
                <div class="col-md-6 lihat-destinasi">
                    <div class="card-body ">
                        <h5 class="card-title">Mari Rawat Dan Lestarikan </h5>
                        <p class="card-text">Budaya adalah suatu warisan atau leluhur dari nenek moyang kita yang tidak ternilai harganya, budaya Manggarai sangat banyak dan beragam, budaya itulah yang seharusnya kita jaga dan kita lestarikan.

                            Manggrai adalah Suku yang sangat terkenal dengan keindahal alamnya dan juga mempunyai beranekaragam bahasa..

                            Budaya itu sangatlah perlu untuk di lestarikan dan salah satu caranya adalah kita mau belajar tari tradisional manggrai ataupun jenis tradisi lainya yang ada di Manggarai , bahkan kalau kita mampu kita juga harus bisa mengajarkannya kepada anak-anak yang masih dini karena pada dasarnya merekalah yang akan menjadi penerus bangsa yang akan memimpin negeri kita tercinta</p>
